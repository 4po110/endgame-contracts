...
contract EGShare is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70,000 egSHAREs
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("EGSHARE", "EGSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 ENDGAME Share for initial pools deployment
