...
contract Masonry is ShareWrapper, ContractGuard {
    ...
    function getEndGamePrice() external view returns (uint256) {
        return treasury.getEndGamePrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            endgame.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        endgame.safeTransferFrom(msg.sender, address(this), amount);
